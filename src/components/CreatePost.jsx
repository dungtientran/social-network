...
const CreatePost = ({ user }) => {
    return (
        <div className='w-[90%] m-auto p-3 bg-[#282828] rounded-lg flex text-white'>
            <div className='w-[10%]'>
            ...
            <div className='w-[90%]'>
                <div>
                    <textarea name="" id="" cols="10" placeholder={`${user.name} ơi, Bạn đang nghĩ gì thế`} className='w-full bg-[#1F1F1F] outline-none rounded-lg p-3 text-white'></textarea>
                </div>
